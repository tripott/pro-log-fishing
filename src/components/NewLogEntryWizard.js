    ...
    <div className="pa4">
      ...
      {equals(props.panel, 'step1') &&
        ...
        >
          <TextField
            ...
            onChange={e =>
              props.setName(props.session.profile.sub, e.target.value)}
          />
        </Panel>}
      ...
      {equals(props.panel, 'step2') &&
        ...
        >
          ...
          <div className="cf">
            <div
              className={`fl pa2 ba tc br1 pointer ${equals(
                props.logEntry.tide.stage,
                'Rising'
              ) && 'bg-black white b--black'}`}
              onClick={e => {
                props.setTide({
            ...
            <div
              className={`fl mh1 pa2 ba tc br1 pointer ${equals(
                props.logEntry.tide.stage,
                'Falling'
              ) && 'bg-black white b--black'}`}
              onClick={e => {
...
const mapActionsToProps = dispatch => {
  return {
    ...
    setName: (profileId, name) => {
      ...
      dispatch({ type: SET_LOG_ENTRY_AUTH_PROFILE_ID, payload: profileId })
